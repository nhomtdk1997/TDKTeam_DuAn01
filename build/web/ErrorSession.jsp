<%-- 
    ...
    Created on : Dec 22, 2016, 5:26:50 PM
    Author     : DuongNguyen
--%>
                ...
                <div class="main-content">
                    <div class="row">
                        <div class="col-twelve">
                            ...
                            <h1 class="kern-this">Login error!</h1>
                            <p>
                                Tài khoản này đang đăng nhập!<br>
                                Bạn có thể đăng nhập bằng tài khoản khác hoặc chờ đến khi phiên làm việc của tài khoản kết thúc<br>
                                Để quay trở lại trang trước hoặc quay về trang chủ bạn hãy chọn liên kết dưới trang
                            </p>
